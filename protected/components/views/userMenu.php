...
<ul class="navbar navbar-inverse  nav navbar-nav side-nav" id="menulateral">
	<li <?php if( strcmp(Yii::app()->controller->id,'profile') == 0 ): ?> class="active" <?php endif; ?>><?php echo CHtml::link('<i class="fa fa-fw fa-home"></i> Principal',array('/user/profile/principal')); ?></li>
