...
<h1><?php echo $model->nombre. " ".$model->apellido1." ".$model->apellido2; ?><small><?php //indico si el inscrito ya ha participado en anteriores ediciones 
 	if( $reincidente ): ?>
 	<span class="label label-warning">Reincidente</span>
  <?php endif; ?>  <small></h1>
